...
$string['invalidmappingaction'] = 'The requested mapping action is invalid.';
$string['missingmappingid'] = 'A mapping must be selected for this action.';
$string['mappingnotexactversion'] = 'The mapping does not belong to this exact question version.';
$string['editdraftonly'] = 'Only a draft mapping from this exact question version can be edited.';
$string['invalidsubmittedmapping'] = 'The submitted draft does not match the exact-version mapping selected for editing.';
$string['postrequired'] = 'This action must be submitted using the provided form.';
$string['invalidbulkselection'] = 'The selected questions are invalid or exceed the supported bulk-operation limit.';
$string['invalidbulkoperation'] = 'The requested bulk operation is invalid.';
$string['invalidweightsjson'] = 'The confirmed assessed-weight data is invalid. Run the preview again.';
